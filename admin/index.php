...
<body>
    ...
    <?php
    //completar nome da página
    /*echo*/ $pagina = $pagina . ".php";
    ...
    if (!isset($_SESSION["hqs"]["id"])) {
        ...
        //se está logado, mostrar home ou a página que está tentando visitar
    ?>
        <!-- Page Wrapper -->
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <?php
                        //cadastrar a programação para abrir a página desejada
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; MEU WEBSITE! 2020</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
